    ...
    <div className="w-full mt-32" id='categorie'>
      ...
      <section className="flex flex-col lg:flex-row w-full mb-15px h-auto lg:h-350px">
        ...
        <Image src={masqueProtection} alt="Masque de Protection" layout="fill" className="object-cover" />
          <p className="absolute bottom-5 right-10 lg:right-20 p-2 text-white font-bold italic text-36 below-xg:text-2xl">EQUIPEMENT DE PROTECTION INDIVIDUELLE</p>
        </div>
        <div className="flex w-full h-64 lg:h-full below-lg:mt-15px">
          <div className="relative w-full h-64 lg:h-full lg:max-w-veste mr-15px">
            ...
            <p className="absolute bottom-5 right-4 lg:right-6 p-2 text-white font-bold italic text-36 below-xg:text-2xl">VETEMENT PERSONNALISER </p>
          </div>
          <div className="relative w-full h-64 lg:h-full lg:max-w-pantalon ">
            ...
            <p className="absolute bottom-5 left-4 p-2 text-white font-bold italic text-36 below-xg:text-2xl">VETEMENT DE TRAVAIL</p>
          </div>
        </div>
      </section>
