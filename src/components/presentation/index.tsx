    ...
    return (
        <div className="flex mt-25 below-xg:flex-col below-xg:mt-12">
            ...
            <div className='flex flex-col flex-1'>
                ...
                <p className='text-16 mt-27 justify-items-center text-center'>Nous vous proposons un large choix d&apos;equipement de protection individuelle grâce à nos différents partenaire. <br/><span className=''>Conseils, qualité, réactivité exigez le meilleur de la sécurité !</span></p>
